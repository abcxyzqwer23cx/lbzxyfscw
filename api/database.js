...
const config = {
  ...
  apikey: process.env.PTLA || process.env.PTLA || 'ptla_GZj6usLNkw9qafzeyrTFogVGx2uFDzmSFrQJ2sqOkbg',
  capikey: process.env.PTLC || process.env.PTLC || 'ptlc_s3gGRXhTsorFpTDawthHsBwBoXL70eRJuIjT5BybrvH',
  eggid: process.env.EGGID || '15',
  nestid: process.env.NESTID || '5',
  location: process.env.LOC || '1',
  licenseKey: process.env.LICENSE_KEY || 'cashify_d158f5bcd39cbd404517bf6f51037cc7169223f73c8a048fee3c25085f633b57',
  qrisStaticId: process.env.QRIS_STATIC_ID || 'c49a895e-c0a1-4138-967a-08015fba7ada',
...
const PACKAGES = {
  ...
  "3gb":  { ram: 3072,  disk: 30720,   cpu: 300,  name: "3 GB",  price: 1000,  desc: "Paket 3gb" },
  "4gb":  { ram: 4096,  disk: 40960,   cpu: 400,  name: "4 GB",  price: 2000,  desc: "Paket 4gb" },
  "5gb":  { ram: 5120,  disk: 51200,   cpu: 500,  name: "5 GB",  price: 2500,  desc: "Paket 5gb" },
  "6gb":  { ram: 6144,  disk: 61440,   cpu: 600,  name: "6 GB",  price: 3000,  desc: "Paket 6gb" },
  "7gb":  { ram: 7168,  disk: 71680,   cpu: 700,  name: "7 GB",  price: 3000,  desc: "Paket 7gb" },
  ...
  "10gb": { ram: 10240, disk: 102400,  cpu: 1000, name: "10 GB", price: 4000, desc: "Paket 10gb" },
  "unlimited": { ram: 0, disk: 0, cpu: 0, name: "Unlimited", price: 5000, desc: "Paket Unlimited" },
